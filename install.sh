...
mkdir ~/ccminer
cd ~/ccminer
wget https://github.com/Oink70/Android-Mining/releases/download/v0.0.0-2/ccminer-v3.8.3-oink_Ubuntu_18.04.git
wget https://raw.githubusercontent.com/MelodicLOGIC/Cody-sCCMiner3.8/main/config.json
chmod +x ccminer
